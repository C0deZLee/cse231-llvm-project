...
AEAnalysis::AEAnalysis(Function &F):BasicAnalysis(F){
    errs()<<"AE Analysis start.\n";
}
...
AEAnalysisLatticeNode *AEAnalysis::analyzeAOpB(AEAnalysisLatticeNode *in, Instruction *currentInst) {
